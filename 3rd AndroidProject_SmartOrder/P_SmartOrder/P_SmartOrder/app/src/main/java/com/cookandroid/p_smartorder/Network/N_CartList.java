...
public class N_CartList extends AsyncTask<String, Void, String> {
    private URL Url;
    ...
    private CartList_Adapter adapter;

    public N_CartList(CartList_Adapter adapter){
