				...
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background">
							<img src="../upload/${single.fileName }" class="coffeeimg" width="100%" height="100%">
						</div>
						<div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
							<h4 class="blog_title"><a href="productView.me?pnum=${single.pnum}">${single.product}</a></h4>							
							<span class="blog_meta"></span>
							<!-- 장바구니 담기 -->										
							<a class="blog_more" href="javascript:goCart('${single.product }','${single.ptype }')">장바구니 담기</a>
						</div>
					</div>
				</div>				
		</c:forEach>		
